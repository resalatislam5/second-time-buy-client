...
const Microbus = () => {
    ...
    return (
        ...
        <div className='grid xl:grid-cols-4 lg:absolute lg:grid-cols-3 md:grid-cols-2 grid-cols-1'>
            {
                microbus.slice(0,4).map(e => <div  className='lg:w-[400px] mx-auto w-[23rem] my-5 lg:my-0 lg:h-[448px] hover:h-[512px] hover:bg-white hover:shadow-lg p-4 bg-[#F9F9F9] rounded-xl Electric' key={e._id}>
